...
class AgenceService {
  ...
  Future<List<dynamic>> getAgences() async {
    print('Début de l\'appel à /agences/');
    final url = Uri.parse('$baseUrl/agences/');
    ...
    try {
      ...
      print('Réponse API (agences): ${response.statusCode} - ${response.body}');
      ...
      print('Erreur lors de l\'appel à /agences/: $e');
      ...
      throw Exception('Erreur lors de l\'appel à /agences/: $e');
    }
  }
}
