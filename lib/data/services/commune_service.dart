...
class CommuneService {
  ...
  Future<List<dynamic>> getCommunes() async {
    print('Début de l\'appel à /communes/');
    final url = Uri.parse('$baseUrl/communes/');
    ...
    try {
      ...
      print(
          'Réponse API (communes): ${response.statusCode} - ${response.body}');
      ...
      print('Erreur lors de l\'appel à /communes/: $e');
      ...
      throw Exception('Erreur lors de l\'appel à /communes/: $e');
    }
  }
}
