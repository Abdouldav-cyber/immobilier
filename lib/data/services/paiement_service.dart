...
class PaiementService {
  ...
  Future<List<dynamic>> getPaiements() async {
    print('Début de l\'appel à /paiements/');
    final url = Uri.parse('$baseUrl/paiements/');
    ...
    try {
      ...
      print(
          'Réponse API (paiements): ${response.statusCode} - ${response.body}');
      ...
      print('Erreur lors de l\'appel à /paiements/: $e');
      ...
      throw Exception('Erreur lors de l\'appel à /paiements/: $e');
    }
  }
}
