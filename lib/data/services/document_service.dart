...
class DocumentService {
  ...
  Future<List<dynamic>> getDocuments() async {
    print('Début de l\'appel à /documents/');
    ...
    try {
      ...
      print(
          'Réponse API (documents): ${response.statusCode} - ${response.body}');
      ...
      print('Erreur lors de l\'appel à /documents/: $e');
      ...
      throw Exception('Erreur lors de l\'appel à /documents/: $e');
    }
  }
}
